...
--
-- Name: elements uname; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements usymbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT usymbol UNIQUE (symbol);


--
-- Name: properties fkey_atomic; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkey_atomic FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties fkey_type; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkey_type FOREIGN KEY (type_id) REFERENCES public.types(type_id);
